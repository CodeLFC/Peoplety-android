 ...
 *
 * LocalDataReciever.java at 2022-7-28 17:24:48, code by Jack Jiang.
 */
...
public class LocalDataReceiver {
    ...
    private final static String TAG = LocalDataReceiver.class.getSimpleName();
    ...
    public void handleProtocol(final byte[] fullProtocolOfBody) {
        MBThreadPoolExecutor.runOnMainThread(() -> handleProtocolImpl(fullProtocolOfBody));
    }
